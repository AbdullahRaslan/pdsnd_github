...
def get_filters():
    ...
    while True:
        city = input('Select the city you like to see data for: Chicago, New York or Washington.\n').lower()
        if city in cities:
            break
...
def user_stats(df,city):
    ...
    # Display earliest, most recent, and most common year of birth
        ...
        print('The oldest, youngest and most popular year of birth, respectively is:\n{}, {} and {}'.format(int(oldest_birth), int(youngest_birth), int(common_birth)))
    else:
...
def display_raw_data(city):
    ...
    while True:
        try:
            ...
            display_data = input("Would you like to preview the raw data? Enter yes or no.\n").lower()
            if display_data != 'yes':
                print('Thank You')
                break
